...
<head>
	...
	<title>Absen SMS-indonesia | Login</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto mt-5">
					<section id="login-body" class="pt-3" style="background-color: salmon ;">
						<div class="card border-0 shadow pt-3" style="background-color:indigo; color:aliceblue">
							<div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
								<img src="<?= base_url('assets/img/logo-smsi.png') ?>" alt="Logo SMS-indonesia" class="img-fluid mx-auto d-block">
								<div class="mt-3">
